...
const About = () => {
  return (
    <section className="bg-gradient-to-r from-gray-200 to-gray-400 py-10 px-6">
      <div className="max-w-6xl mx-auto bg-white shadow-md rounded-lg p-8 flex flex-col md:flex-row items-center">
        {/* Left Section - Image */}
        <div className="flex-shrink-0 mb-6 md:mb-0 md:mr-8">
          <div className="w-48 h-48 md:w-56 md:h-56 rounded-full overflow-hidden border-4 border-gray-300 shadow-lg">
            <img
              src={pp}
              alt="Profile"
        ...
        <div className="text-gray-800">
          ...
          <p className="mb-4">
            ...
            <br />
            Saya Seorang UI/UX Designer Dengan 1 Bulan Pengalaman Dalam
            Menciptakan Pengalaman Digital Yang Intuitif, Menarik, Dan Berbasis
            Kebutuhan Pengguna.
          </p>
          <p className="mb-4">
            Dengan Latar Belakang Di Desainer Grafis, Saya Memadukan Kreativitas
